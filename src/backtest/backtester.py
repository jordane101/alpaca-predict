...
if __name__ == '__main__':
    ...
    # active_strategy = HMMStrategy(n_components=2, model_order=1, optimize_order=False)  # Updated to 2 components

    # == Option 2: Donchian Breakout Strategy ==
    from src.trading.strategies import DonchianBreakoutStrategy
